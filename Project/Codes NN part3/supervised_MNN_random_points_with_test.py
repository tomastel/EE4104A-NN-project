''' MNN example: random points, with data splitted to training set and test set'''
...
train_history = model.fit(x=x_input, y=y_expect, validation_split=0.2, epochs=300, batch_size=20, verbose=2)
